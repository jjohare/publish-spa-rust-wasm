...
program
  .name('logseq-publish')
  .description('Publish Logseq graphs to static HTML')
  .version('0.1.0');
...
program
  ...
  .action(async (options) => {
    try {
      ...
      const { publish } = await import('../dist/index.js');
...
program
  ...
  .action(async (options) => {
    try {
      ...
      const { parseGraph } = await import('../dist/index.js');
...
program
  ...
  .action(async (page, options) => {
    try {
      ...
      const { getBacklinks } = await import('../dist/index.js');
